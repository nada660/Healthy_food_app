...
class Authenticated extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<VerfyCodeControllerImp>(
              ...
              children: [
                ...
                Container(
                  margin: EdgeInsets.symmetric(
                      horizontal: height * .03, vertical: width * .06),
                  child: Text(
                    "Verification Code",
                ...
                Container(
                  margin: EdgeInsets.symmetric(
                      horizontal: height * .03, vertical: width * .02),
                  child: Text(
                ...
                Container(
                  margin: EdgeInsets.symmetric(horizontal: height * .03),
                  child: Text(
                    "your email address",
                    textAlign: TextAlign.start,
                    style: GoogleFonts.getFont(
                ...
                Container(
                  margin: EdgeInsets.symmetric(horizontal: height * .05),
                  width: width,
                  child: Center(
                    child: OTPTextField(
                ...
                InkWell(
                  onTap: () {
                    Get.find<VerfyCodeControllerImp>().resendCode();
                  },
                  child: Container(
                ...
                controller.statusRequest == StatusRequest.loading
                    ...
                    : Container(
                        ...
                        child: CustomButtom(
                          ...
                          onPressed: () {
                            controller.checkCode(verfycode);
                          },
                        ),
                      ),
              ],
